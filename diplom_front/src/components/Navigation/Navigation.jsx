...
function Navigation(props) {
  ...
  return (
    <section>
      {isMain() && !isLoggedIn ? (
        <nav>
          <NavLink to="/signup" replace className="menu__registration">
            Регистрация
          </NavLink>
          <NavLink to="/signin" replace className="menu__signin">
            Войти
          </NavLink>
        </nav>
      ) : (
        <div>
          <nav ref={navRef} className="menu__navbar">
            <div className="menu__navbar-block">
              <button
                onClick={shawNavBar}
                className="menu__close-btn menu__btn"
              ></button>
              <div className="menu__links">
                ...
                <NavLink
                  ...
                  className={`menu__link ${
                    location.pathname === "/movies" ? `menu__here` : ``
                  }`}
                >
                  Фильмы
                </NavLink>
                <NavLink
                  ...
                  replace
                  className={`menu__link ${
                    location.pathname === "/saved-movies" ? `menu__here` : ``
                  }`}
                >
                  Сохраненные фильмы
                </NavLink>
          ...
          <button
            onClick={shawNavBar}
            className="menu__btn menu__open-btn"
          ></button>
        </div>
      )}
    </section>
